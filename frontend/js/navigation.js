...
var onMouseMove = function(e){
    ...
    if (mouse.down ) {
        ...
        camPos.v = Math.min(camPos.v, 180);
        camPos.v = Math.max(camPos.v, 1);
        moveCamera();
    }
}
...
var onMouseWheel = function (e) {
    ...
    camPos.distance = Math.min(camPos.distance, maxDistance);
    camPos.distance = Math.max(camPos.distance, minDistance);
    moveCamera();   
}
